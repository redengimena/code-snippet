                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-header flex-wrap border-0 pb-0">
                            <h3 class="fs-24 text-black font-w600 mr-auto mb-2 pr-3">Podcasts</h3>
                            <a href="#" data-toggle="modal" data-target="#addPodcastModal" class="btn btn-primary btn-rounded mb-2">Add</a>
                            <form id="addForm" action="{{ route('admin.podcasts.add') }}" method="POST" class="d-none">
                                @csrf
                                <input type="text" name="feed_url" value=""/>
                            </form>
                        </div>
                        <div class="card-body top-show-list">
                            <div class="dd">
                                <ol class="dd-list">
                                    ...
                                    <li class="dd-item" data-id="{{$podcast->id}}">
                                        <div class="row p-3">
                                            <div class="col-sm-1"><img class="img-fluid" src="{{$podcast->image}}" /></div>
                                            <div class="col-sm-9">
...
<script src="{{ asset('js/admin/podcasts.min.js') }}" type="text/javascript"></script>
@endpush