            ...
            <div class="row no-gutters">
                <div class="col-xl-12">
                    <div class="auth-form">
												...
												<h4 class="text-center mb-4 text-white">Please read our Podcaster guidelines.</h4>

												<div id="guidelines" class="text-left overflow-auto bg-white mb-3 p-2" style="height: 400px;">
