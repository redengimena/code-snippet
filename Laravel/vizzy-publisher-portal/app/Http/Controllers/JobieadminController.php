...
class JobieadminController extends Controller
{
    ...
    public function application()
    {
        ...
        return view('dashboard.application', compact('page_title', 'page_description','action','logo','logoText'));
    }
    ...
    public function companies()
    {
        ...
        return view('dashboard.companies', compact('page_title', 'page_description','action','logo','logoText'));
    }
	
	     // Post Details
    public function dashboard_post_details()
    {
        ...
        return view('dashboard.post_details', compact('page_title', 'page_description','action','logo','logoText'));
    }
    ...
    public function search_job()
    {
        ...
        return view('dashboard.search_job', compact('page_title', 'page_description','action','logo','logoText'));
    }
	    // Statistics
    public function statistics()
    {
        ...
        return view('dashboard.statistics', compact('page_title', 'page_description','action','logo','logoText'));
    }
	    // Calender
